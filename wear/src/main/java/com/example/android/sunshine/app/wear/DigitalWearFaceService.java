...
public class DigitalWearFaceService extends CanvasWatchFaceService {
    ...
    private static String LOG_TAG = DigitalWearFaceService.class.getSimpleName();
    ...
    private class Engine extends CanvasWatchFaceService.Engine implements DataApi.DataListener,GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
        ...
        GoogleApiClient mGoogleApiClient = new GoogleApiClient.Builder(DigitalWearFaceService.this)
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(DigitalWearFaceService.this)
                    .setCardPeekMode(WatchFaceStyle.PEEK_MODE_SHORT)
                    .setBackgroundVisibility(WatchFaceStyle.BACKGROUND_VISIBILITY_INTERRUPTIVE)
                    .setShowSystemUiTime(false)
                    .build());
            Resources resources = DigitalWearFaceService.this.getResources();
        ...
        private void registerReceiver() {
            ...
            DigitalWearFaceService.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterReceiver() {
            ...
            DigitalWearFaceService.this.unregisterReceiver(mTimeZoneReceiver);
        }
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            boolean is24Hour = DateFormat.is24HourFormat(DigitalWearFaceService.this);
